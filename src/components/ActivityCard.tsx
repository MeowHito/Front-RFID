...
export default function ActivityCard({
    ...
    return (
        <div className="bg-white dark:bg-[#1e1e2a] rounded-lg shadow-md border border-gray-200 dark:border-[#3a3a4a] overflow-hidden mb-5 transition-all hover:shadow-lg">
            {/* ===== MOBILE LAYOUT ===== */}
            ...
            <div className="hidden md:flex md:flex-row" style={{ borderLeft: `5px solid ${color}`, height: '160px' }}>
                ...
                <div className="relative shrink-0" style={{ width: '30%', maxWidth: '280px' }}>
