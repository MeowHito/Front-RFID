 ...
 * return the same `{ data: { runner, timingRecords, campaign } }` shape as
 * `/api/runner/:id`), then renders the selected e-slip template.
 *
 * Two routes mount this: `/runner/[id]/eslip` (apiUrl=/api/runner/:id) and the
 * pretty public URL `/[eventSlug]/[bib]` (apiUrl=/api/eslip/:slug/:bib).
 */
export default function ESlipView({ apiUrl }: { apiUrl: string }) {
